...
const loadLottieAnimation = () => {
  const animation = lottie.loadAnimation({
    ...
    renderer: 'svg', // Pilih renderer sesuai kebutuhan (svg / canvas)
    loop: true,
    autoplay: true,
    path: './dist/images/component/bionicom_lottie.json' // Ganti dengan path lokasi file animasi Lottie Anda
  });
};

// Panggil fungsi untuk memuat animasi Lottie saat halaman dimuat
