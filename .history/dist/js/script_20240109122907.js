...
const loadLottieAnimation = () => {
  const animation = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: 'dist/images/component/bionicom_lottie.json' // Ganti dengan lokasi file animasi Lottie Anda
  });
};

// Kode untuk menetapkan gambar blob sebagai latar belakang
const setBlobBackground = () => {
  const blobShape = document.querySelector('.blob-shape');
  blobShape.style.backgroundImage = 'url("dist/images/component/blob.svg")'; // Ganti dengan path gambar blob Anda
};

// Panggil fungsi-fungsi di atas untuk memuat animasi Lottie dan menetapkan gambar blob
loadLottieAnimation();
setBlobBackground();